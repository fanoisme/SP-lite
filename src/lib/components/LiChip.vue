...
.li-chip--success { background: var(--color-green-100, #ECFF8F); color: var(--color-green-400, #10B981); }
...
.li-chip--error { background: var(--color-red-100, #D4A73F); color: var(--color-red-400, #C83E3B); }
